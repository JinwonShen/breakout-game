(function () {
  ...
  class BrickBreak {
    constructor(parent = "body", data = {}) {
      ...
      this.fontFamily =
        "20px system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif";
      this.score = 0;
    ...
    drawBall = () => {
      this.ctx.beginPath();
      this.ctx.arc(this.ballX, this.ballY, this.radius, 0, this.canvas.height);
